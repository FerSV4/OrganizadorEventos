...
- Create Angular project with ng: `ng new organizadoreventos.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`organizadoreventos.client.esproj`).
